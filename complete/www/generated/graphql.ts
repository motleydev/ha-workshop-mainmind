...
export type CreateGameMutation = { __typename?: 'mutation_root', insert_user_game_one?: { __typename?: 'user_game', id: any, game_id: any } | null };
...
export type GetOriginalGameCodeQuery = { __typename?: 'query_root', user_game_by_pk?: { __typename?: 'user_game', user_hash: string, user_guesses_aggregate: { __typename?: 'user_guess_aggregate', aggregate?: { __typename?: 'user_guess_aggregate_fields', count: number } | null }, game: { __typename?: 'game', id: any, code_complexity: number, code: any } } | null };

export type GetLatestGameQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLatestGameQuery = { __typename?: 'query_root', game: Array<{ __typename?: 'game', id: any, code_complexity: number, code_length: number }> };
...
export const YouLostDocument = gql`
    mutation YouLost($user_game_id: uuid!, $game_id: uuid!, $guess_id: uuid!, $result_code: _numeric, $input_code: _numeric, $user_hash: String!) {
  insert_user_game_one(
    object: {id: $user_game_id, game_id: $game_id, user_hash: $user_hash, lost_at: "now()", user_guesses: {data: {id: $guess_id, result_code: $result_code, user_hash: $user_hash, input_code: $input_code}, on_conflict: {update_columns: [result_code], constraint: user_guess_pkey}}}
...
export const YouWonDocument = gql`
    mutation YouWon($user_game_id: uuid!, $game_id: uuid!, $guess_id: uuid!, $result_code: _numeric, $input_code: _numeric, $user_hash: String!) {
  insert_user_game_one(
    object: {id: $user_game_id, game_id: $game_id, user_hash: $user_hash, completed_at: "now()", user_guesses: {data: {id: $guess_id, result_code: $result_code, user_hash: $user_hash, input_code: $input_code}, on_conflict: {update_columns: [result_code], constraint: user_guess_pkey}}}
